...
const Summary = ({ leadDetails }: { leadDetails: LeadDetails }) => {
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { icon: ServerCrash, label: "Tax", value: "$0" },
        { icon: ScissorsIcon, label: "Discount", value: "$0" },
        {
  ...
  return (
    <motion.div
      ...
      className="max-h-[calc(100vh-2rem)] space-y-4 overflow-y-auto rounded-3xl bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-4 shadow-2xl"
    >

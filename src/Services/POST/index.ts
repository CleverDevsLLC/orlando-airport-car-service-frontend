...
export const addNewCompany = async (
  ...
  const response = await axios
    .post(`${API.uri}/companysetup`, payload, {
      headers: {
...
export const adminLogin = async (payload: adminPayload) => {
  const response = await axios
    .post(`${API.uri}/auth/login`, payload)
    .then((res) => {
      console.log(res);
      return res;
    })
...
export const findCompany = async (companyId: string) => {
  const response = await axios
    .post(`${API.uri}/auth/findcompany`, { companyId })
    .then((res) => {
      return res;
    })
    .catch((e) => {
...
export const adminSignup = async (payload: AdminSignup) => {
  const response = await axios
    .post(`${API.uri}/auth/signup`, payload)
    .then((res) => {
      console.log(res);
      return res;
    })
...
export const sendManualQuote = async (id: string | null, price: number, additionalPayment: AdditionalPayment[]) => {
  const response = await axios
    .post(`${API.uri}/sendLeads/${id}`, { price: price, additionalPayments: additionalPayment })
    .then((res) => {
      console.log(res);
      return res;
    })
...
export const sendUpdatedQuote = async (id: string | null, price: number, additionalPayment: AdditionalPayment[]) => {
  const response = await axios
    .post(`${API.uri}/leads/updateleadprice`, { leadId: id, price: price, additionalPayments: additionalPayment })
    .then((res) => {
      console.log(res);
      return res;
    })
...
export const sendInvoiceService = async (id: string | null) => {
  const response = await axios
    .post(`${API.uri}/leads/sendinvoice`, { leadId: id})
    .then((res) => {
      console.log(res);
      return res;
    })

      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h1 className="text-3xl font-bold mb-2">Manage Discount</h1>
            <p className="text-indigo-200">Customize and control your discounts</p>
          </div>
        ...
        <div className="mt-8 flex justify-between items-end">
          <div className="w-1/2">
            ...
            <p className="text-indigo-200">
              Optimize your discount strategy to increase overall revenue
            </p>
          </div>
